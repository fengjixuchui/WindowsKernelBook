...
《Windows 内核安全编程技术实践（典藏版）》 是2023年申请登记的（国著）内核安全开发系列PDF电子书，作者是王瑞。本书图文并茂、深入浅出、案例丰富，是Windows内核开发工程师的参考资料，也可供信息安全，软件工程等相关专业本科及以上在校生学习参考。本书是近年来少见的关于揭秘AntiRootkit反内核工具实现细节的相关书籍。
